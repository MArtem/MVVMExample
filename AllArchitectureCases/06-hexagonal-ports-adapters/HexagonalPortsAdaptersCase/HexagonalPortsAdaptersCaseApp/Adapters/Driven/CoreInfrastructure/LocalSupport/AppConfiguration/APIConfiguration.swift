...
enum APIConfigurationError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        switch self {
        case .missingProductionBaseURL:
            return "HEXAGONAL_PORTS_ADAPTERS_CASE_API_BASE_URL is required when demo API fallback is disabled."
...
struct APIConfiguration: Sendable {
    ...
    ///
    /// Environment keys:
    /// - `HEXAGONAL_PORTS_ADAPTERS_CASE_API_BASE_URL`
    /// - `HEXAGONAL_PORTS_ADAPTERS_CASE_API_TIMEOUT_SECONDS`
    /// - `HEXAGONAL_PORTS_ADAPTERS_CASE_ALLOW_DEMO_CREDENTIALS`
    static func current(
    ...
    static func make(environment: [String: String]) throws -> APIConfiguration {
        ...
        let allowsDemoCredentials = environment["HEXAGONAL_PORTS_ADAPTERS_CASE_ALLOW_DEMO_CREDENTIALS"]
        ...
        let timeout = environment["HEXAGONAL_PORTS_ADAPTERS_CASE_API_TIMEOUT_SECONDS"]
    ...
    static func makeBaseURL(
        ...
        guard let configuredBaseURL = environment["HEXAGONAL_PORTS_ADAPTERS_CASE_API_BASE_URL"] else {
