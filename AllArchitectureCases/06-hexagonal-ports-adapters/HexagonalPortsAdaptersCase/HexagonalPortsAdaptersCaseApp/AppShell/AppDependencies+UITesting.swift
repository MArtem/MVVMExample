...
extension AppDependencies {
    ...
    ///
    /// This path is selected only by the explicit `HEXAGONAL_PORTS_ADAPTERS_CASE_UI_TEST_MODE=1` launch environment and avoids live network dependencies for accessibility smoke checks.
