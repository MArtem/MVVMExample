...
readonly PROJECT="HexagonalPortsAdaptersCase.xcodeproj"
readonly SCHEME="HexagonalPortsAdaptersCase"
readonly UNIT_TEST_PLAN="HexagonalPortsAdaptersCase"
readonly UI_TEST_PLAN="HexagonalPortsAdaptersCaseUI"
readonly BUILD_DESTINATION="generic/platform=iOS Simulator"
readonly TEST_DESTINATION="${HEXAGONAL_PORTS_ADAPTERS_CASE_TEST_DESTINATION:-platform=iOS Simulator,name=Any iOS Simulator Device}"
readonly CASE_ROOT="$(cd "$(dirname "$0")/.." && pwd)"
readonly DERIVED_DATA_PATH="${HEXAGONAL_PORTS_ADAPTERS_CASE_DERIVED_DATA_PATH:-${CASE_ROOT}/.xcode-derived-data/HexagonalPortsAdaptersCase}"
readonly CLONED_PACKAGES_PATH="${HEXAGONAL_PORTS_ADAPTERS_CASE_XCODE_PACKAGE_CACHE:-${CASE_ROOT}/.xcode-package-cache/HexagonalPortsAdaptersCase}"
readonly RESULT_BUNDLE_ROOT="${HEXAGONAL_PORTS_ADAPTERS_CASE_RESULT_BUNDLE_PATH:-${CASE_ROOT}/.xcode-result-bundles/HexagonalPortsAdaptersCase}"
...
Levels:
  ...
  build      Build HexagonalPortsAdaptersCase with a generic iOS Simulator destination
