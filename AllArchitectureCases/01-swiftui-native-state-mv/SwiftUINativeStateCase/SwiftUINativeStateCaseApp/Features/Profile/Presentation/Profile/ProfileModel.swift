...
final class ProfileModel {
    ...
    ///
    /// External usage:
    /// Called by the profile navigation composition after `ProfileEditModel` saves successfully.
    ...
    ///
    /// Side effects:
    /// This Model does not clear the session store directly; app coordination owns that transition.
    func logoutTapped() {
        onLogout()
    }
