...
enum APIConfigurationError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        switch self {
        case .missingProductionBaseURL:
            return "SWIFTUI_NATIVE_STATE_CASE_API_BASE_URL is required when demo API fallback is disabled."
...
struct APIConfiguration: Sendable {
    ...
    ///
    /// Environment keys:
    /// - `SWIFTUI_NATIVE_STATE_CASE_API_BASE_URL`
    /// - `SWIFTUI_NATIVE_STATE_CASE_API_TIMEOUT_SECONDS`
    /// - `SWIFTUI_NATIVE_STATE_CASE_ALLOW_DEMO_CREDENTIALS`
    static func current(
    ...
    static func make(environment: [String: String]) throws -> APIConfiguration {
        ...
        let allowsDemoCredentials = environment["SWIFTUI_NATIVE_STATE_CASE_ALLOW_DEMO_CREDENTIALS"]
        ...
        let timeout = environment["SWIFTUI_NATIVE_STATE_CASE_API_TIMEOUT_SECONDS"]
    ...
    static func makeBaseURL(
        ...
        guard let configuredBaseURL = environment["SWIFTUI_NATIVE_STATE_CASE_API_BASE_URL"] else {
