...
string_catalogs = list((root / 'SwiftUINativeStateCase').rglob('*.xcstrings'))
if not string_catalogs:
    print('Missing localization resources: expected at least one .xcstrings file under ./SwiftUINativeStateCase')
    sys.exit(1)
