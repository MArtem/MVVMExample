...
string_catalogs = list((root / 'ReduxElmUDFCase').rglob('*.xcstrings'))
if not string_catalogs:
    print('Missing localization resources: expected at least one .xcstrings file under ./ReduxElmUDFCase')
    sys.exit(1)
