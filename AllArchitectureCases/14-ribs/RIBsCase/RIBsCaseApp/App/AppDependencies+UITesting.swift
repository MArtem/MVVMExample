...
extension AppDependencies {
    ...
    ///
    /// This path is selected only by the explicit `RIBSCASE_UI_TEST_MODE=1` launch environment and avoids live network dependencies for accessibility smoke checks.
...
private struct UITestNewsRepository: NewsRepository {
    private let article = NewsArticle(
        id: 101,
        title: "Accessible RIBs news card",
