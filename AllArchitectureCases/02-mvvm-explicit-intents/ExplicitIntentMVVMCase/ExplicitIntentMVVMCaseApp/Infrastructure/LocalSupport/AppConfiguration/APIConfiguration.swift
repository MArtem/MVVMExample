...
enum APIConfigurationError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        switch self {
        case .missingProductionBaseURL:
            return "EXPLICIT_INTENT_MVVM_CASE_API_BASE_URL is required when demo API fallback is disabled."
...
struct APIConfiguration: Sendable {
    ...
    ///
    /// Environment keys:
    /// - `EXPLICIT_INTENT_MVVM_CASE_API_BASE_URL`
    /// - `EXPLICIT_INTENT_MVVM_CASE_API_TIMEOUT_SECONDS`
    /// - `EXPLICIT_INTENT_MVVM_CASE_ALLOW_DEMO_CREDENTIALS`
    static func current(
    ...
    static func make(environment: [String: String]) throws -> APIConfiguration {
        ...
        let allowsDemoCredentials = environment["EXPLICIT_INTENT_MVVM_CASE_ALLOW_DEMO_CREDENTIALS"]
        ...
        let timeout = environment["EXPLICIT_INTENT_MVVM_CASE_API_TIMEOUT_SECONDS"]
    ...
    static func makeBaseURL(
        ...
        guard let configuredBaseURL = environment["EXPLICIT_INTENT_MVVM_CASE_API_BASE_URL"] else {
