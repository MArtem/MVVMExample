...
readonly PROJECT="ExplicitIntentMVVMCase.xcodeproj"
readonly SCHEME="ExplicitIntentMVVMCase"
readonly UNIT_TEST_PLAN="ExplicitIntentMVVMCase"
readonly UI_TEST_PLAN="ExplicitIntentMVVMCaseUI"
readonly BUILD_DESTINATION="generic/platform=iOS Simulator"
readonly TEST_DESTINATION="${EXPLICIT_INTENT_MVVM_CASE_TEST_DESTINATION:-platform=iOS Simulator,name=Any iOS Simulator Device}"
readonly CASE_ROOT="$(cd "$(dirname "$0")/.." && pwd)"
readonly DERIVED_DATA_PATH="${EXPLICIT_INTENT_MVVM_CASE_DERIVED_DATA_PATH:-${CASE_ROOT}/.xcode-derived-data/ExplicitIntentMVVMCase}"
readonly CLONED_PACKAGES_PATH="${EXPLICIT_INTENT_MVVM_CASE_XCODE_PACKAGE_CACHE:-${CASE_ROOT}/.xcode-package-cache/ExplicitIntentMVVMCase}"
readonly RESULT_BUNDLE_ROOT="${EXPLICIT_INTENT_MVVM_CASE_RESULT_BUNDLE_PATH:-${CASE_ROOT}/.xcode-result-bundles/ExplicitIntentMVVMCase}"
...
Levels:
  ...
  build      Build ExplicitIntentMVVMCase with a generic iOS Simulator destination
