...
enum APIConfigurationError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        switch self {
        case .missingProductionBaseURL:
            return "REACTOR_STYLE_CASE_API_BASE_URL is required when demo API fallback is disabled."
...
struct APIConfiguration: Sendable {
    ...
    ///
    /// Environment keys:
    /// - `REACTOR_STYLE_CASE_API_BASE_URL`
    /// - `REACTOR_STYLE_CASE_API_TIMEOUT_SECONDS`
    /// - `REACTOR_STYLE_CASE_ALLOW_DEMO_CREDENTIALS`
    static func current(
    ...
    static func make(environment: [String: String]) throws -> APIConfiguration {
        ...
        let allowsDemoCredentials = environment["REACTOR_STYLE_CASE_ALLOW_DEMO_CREDENTIALS"]
        ...
        let timeout = environment["REACTOR_STYLE_CASE_API_TIMEOUT_SECONDS"]
    ...
    static func makeBaseURL(
        ...
        guard let configuredBaseURL = environment["REACTOR_STYLE_CASE_API_BASE_URL"] else {
