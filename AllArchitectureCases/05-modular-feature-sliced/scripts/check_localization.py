...
string_catalogs = list((root / 'ModularFeatureSlicedCase').rglob('*.xcstrings'))
if not string_catalogs:
    print('Missing localization resources: expected at least one .xcstrings file under ./ModularFeatureSlicedCase')
    sys.exit(1)
