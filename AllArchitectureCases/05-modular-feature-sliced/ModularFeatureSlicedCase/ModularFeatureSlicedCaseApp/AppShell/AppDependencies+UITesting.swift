...
extension AppDependencies {
    ...
    ///
    /// This path is selected only by the explicit `MODULAR_FEATURE_SLICED_CASE_UI_TEST_MODE=1` launch environment and avoids live network dependencies for accessibility smoke checks.
