...
enum APIConfigurationError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        switch self {
        case .missingProductionBaseURL:
            return "MODULAR_FEATURE_SLICED_CASE_API_BASE_URL is required when demo API fallback is disabled."
...
struct APIConfiguration: Sendable {
    ...
    ///
    /// Environment keys:
    /// - `MODULAR_FEATURE_SLICED_CASE_API_BASE_URL`
    /// - `MODULAR_FEATURE_SLICED_CASE_API_TIMEOUT_SECONDS`
    /// - `MODULAR_FEATURE_SLICED_CASE_ALLOW_DEMO_CREDENTIALS`
    static func current(
    ...
    static func make(environment: [String: String]) throws -> APIConfiguration {
        ...
        let allowsDemoCredentials = environment["MODULAR_FEATURE_SLICED_CASE_ALLOW_DEMO_CREDENTIALS"]
        ...
        let timeout = environment["MODULAR_FEATURE_SLICED_CASE_API_TIMEOUT_SECONDS"]
    ...
    static func makeBaseURL(
        ...
        guard let configuredBaseURL = environment["MODULAR_FEATURE_SLICED_CASE_API_BASE_URL"] else {
