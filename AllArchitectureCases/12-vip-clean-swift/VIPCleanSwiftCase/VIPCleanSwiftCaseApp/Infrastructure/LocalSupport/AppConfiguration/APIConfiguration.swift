...
enum APIConfigurationError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        switch self {
        case .missingProductionBaseURL:
            return "VIPCLEANSWIFTCASE_API_BASE_URL is required when demo API fallback is disabled."
...
struct APIConfiguration: Sendable {
    ...
    ///
    /// Environment keys:
    /// - `VIPCLEANSWIFTCASE_API_BASE_URL`
    /// - `VIPCLEANSWIFTCASE_API_TIMEOUT_SECONDS`
    /// - `VIPCLEANSWIFTCASE_ALLOW_DEMO_CREDENTIALS`
    static func current(
    ...
    static func make(environment: [String: String]) throws -> APIConfiguration {
        ...
        let allowsDemoCredentials = environment["VIPCLEANSWIFTCASE_ALLOW_DEMO_CREDENTIALS"]
        ...
        let timeout = environment["VIPCLEANSWIFTCASE_API_TIMEOUT_SECONDS"]
    ...
    static func makeBaseURL(
        ...
        guard let configuredBaseURL = environment["VIPCLEANSWIFTCASE_API_BASE_URL"] else {
