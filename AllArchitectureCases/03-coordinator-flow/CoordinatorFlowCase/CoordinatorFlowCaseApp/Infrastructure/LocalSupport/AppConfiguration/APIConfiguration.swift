...
enum APIConfigurationError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        switch self {
        case .missingProductionBaseURL:
            return "COORDINATOR_FLOW_CASE_API_BASE_URL is required when demo API fallback is disabled."
...
struct APIConfiguration: Sendable {
    ...
    ///
    /// Environment keys:
    /// - `COORDINATOR_FLOW_CASE_API_BASE_URL`
    /// - `COORDINATOR_FLOW_CASE_API_TIMEOUT_SECONDS`
    /// - `COORDINATOR_FLOW_CASE_ALLOW_DEMO_CREDENTIALS`
    static func current(
    ...
    static func make(environment: [String: String]) throws -> APIConfiguration {
        ...
        let allowsDemoCredentials = environment["COORDINATOR_FLOW_CASE_ALLOW_DEMO_CREDENTIALS"]
        ...
        let timeout = environment["COORDINATOR_FLOW_CASE_API_TIMEOUT_SECONDS"]
    ...
    static func makeBaseURL(
        ...
        guard let configuredBaseURL = environment["COORDINATOR_FLOW_CASE_API_BASE_URL"] else {
