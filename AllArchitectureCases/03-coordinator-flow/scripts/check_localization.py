...
string_catalogs = list((root / 'CoordinatorFlowCase').rglob('*.xcstrings'))
if not string_catalogs:
    print('Missing localization resources: expected at least one .xcstrings file under ./CoordinatorFlowCase')
    sys.exit(1)
