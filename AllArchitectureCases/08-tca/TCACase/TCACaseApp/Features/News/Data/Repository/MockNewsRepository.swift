...
extension NewsArticle {
    static let fixture = NewsArticle(
        id: 1,
        title: "TCA Navigation Architecture",
        excerpt: "A practical demo of typed routers, coordinators, repositories, DTO mapping and view state.",
        source: "DummyJSON",
        category: "architecture",
        rating: 4.8,
        thumbnailURL: URL(string: "https://dummyjson.com/image/400x200/282828/eaeaea?text=TCA"),
        imageURLs: [URL(string: "https://dummyjson.com/image/900x500/282828/eaeaea?text=TCA")!],
