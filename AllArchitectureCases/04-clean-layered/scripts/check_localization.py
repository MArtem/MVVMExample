...
string_catalogs = list((root / 'CleanLayeredCase').rglob('*.xcstrings'))
if not string_catalogs:
    print('Missing localization resources: expected at least one .xcstrings file under ./CleanLayeredCase')
    sys.exit(1)
