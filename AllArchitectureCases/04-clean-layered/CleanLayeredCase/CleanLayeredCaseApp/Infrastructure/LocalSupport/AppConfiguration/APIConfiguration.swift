...
enum APIConfigurationError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        switch self {
        case .missingProductionBaseURL:
            return "CLEAN_LAYERED_CASE_API_BASE_URL is required when demo API fallback is disabled."
...
struct APIConfiguration: Sendable {
    ...
    ///
    /// Environment keys:
    /// - `CLEAN_LAYERED_CASE_API_BASE_URL`
    /// - `CLEAN_LAYERED_CASE_API_TIMEOUT_SECONDS`
    /// - `CLEAN_LAYERED_CASE_ALLOW_DEMO_CREDENTIALS`
    static func current(
    ...
    static func make(environment: [String: String]) throws -> APIConfiguration {
        ...
        let allowsDemoCredentials = environment["CLEAN_LAYERED_CASE_ALLOW_DEMO_CREDENTIALS"]
        ...
        let timeout = environment["CLEAN_LAYERED_CASE_API_TIMEOUT_SECONDS"]
    ...
    static func makeBaseURL(
        ...
        guard let configuredBaseURL = environment["CLEAN_LAYERED_CASE_API_BASE_URL"] else {
