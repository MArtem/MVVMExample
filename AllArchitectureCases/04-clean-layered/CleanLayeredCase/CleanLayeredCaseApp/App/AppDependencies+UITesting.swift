...
extension AppDependencies {
    ...
    ///
    /// This path is selected only by the explicit `CLEAN_LAYERED_CASE_UI_TEST_MODE=1` launch environment and avoids live network dependencies for accessibility smoke checks.
