...
/// MVC migration controller for the news list screen.
///
/// Ownership:
/// Created by the news list screen for one navigation flow.
///
/// Migration boundary:
/// This type intentionally owns list state, pagination, navigation callbacks, repository reads, optimistic likes, and local interaction merge for one legacy-shaped screen controller. It remains screen-scoped to demonstrate incremental MVC migration without creating one app-wide massive controller.
///
/// Concurrency:
