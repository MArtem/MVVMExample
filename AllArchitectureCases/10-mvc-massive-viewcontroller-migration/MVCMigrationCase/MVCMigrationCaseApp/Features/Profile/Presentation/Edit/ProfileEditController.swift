...
/// MVC migration controller for the editable profile form.
///
/// Ownership:
/// Created by the profile edit route for a single edit transaction.
///
/// Migration boundary:
/// This type intentionally owns form fields, save/cancel UI events, repository update, routing, and save result propagation for one legacy-shaped screen controller.
@MainActor
@Observable
final class ProfileEditController {
