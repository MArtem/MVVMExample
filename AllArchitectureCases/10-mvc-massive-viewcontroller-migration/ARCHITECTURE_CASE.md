# MVC / Massive ViewController Migration

## Case Folder
`./AllArchitectureCases/10-mvc-massive-viewcontroller-migration`

## Target Architecture
MVC / Massive ViewController Migration

## Purpose
Legacy migration case focused on incremental responsibility extraction rather than greenfield MVC.
