...
limit = 5 * 1024 * 1024
exclude = {'.git', 'DerivedData', '.build', '.zenflow', '.zenflow-attachments', '.xcode-derived-data', '.xcode-package-cache', '.xcode-result-bundles', 'docs/reusable-baseline/external-environment'}
large=[]
