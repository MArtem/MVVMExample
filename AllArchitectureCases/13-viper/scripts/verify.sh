...
readonly UNIT_TEST_PLAN="VIPERArchitectureCase"
readonly UI_TEST_PLAN="VIPERArchitectureCaseUI"
...
Levels:
  ...
  build      Build VIPERArchitectureCase with a generic iOS Simulator destination
