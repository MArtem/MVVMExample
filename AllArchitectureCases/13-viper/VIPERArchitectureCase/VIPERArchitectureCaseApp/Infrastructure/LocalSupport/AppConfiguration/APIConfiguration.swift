...
enum APIConfigurationError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        switch self {
        case .missingProductionBaseURL:
            return "VIPER_ARCHITECTURE_CASE_API_BASE_URL is required when demo API fallback is disabled."
...
struct APIConfiguration: Sendable {
    ...
    ///
    /// Environment keys:
    /// - `VIPER_ARCHITECTURE_CASE_API_BASE_URL`
    /// - `VIPER_ARCHITECTURE_CASE_API_TIMEOUT_SECONDS`
    /// - `VIPER_ARCHITECTURE_CASE_ALLOW_DEMO_CREDENTIALS`
    static func current(
    ...
    static func make(environment: [String: String]) throws -> APIConfiguration {
        ...
        let allowsDemoCredentials = environment["VIPER_ARCHITECTURE_CASE_ALLOW_DEMO_CREDENTIALS"]
        ...
        let timeout = environment["VIPER_ARCHITECTURE_CASE_API_TIMEOUT_SECONDS"]
    ...
    static func makeBaseURL(
        ...
        guard let configuredBaseURL = environment["VIPER_ARCHITECTURE_CASE_API_BASE_URL"] else {
