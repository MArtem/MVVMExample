...
struct ProfilePresenterTests {
    ...
    func appearedLoadsCurrentProfileIntoContentState() async {
        ...
        let presenter = makeProfilePresenter(repository: repository)
    ...
    func profileUpdateAppliesReturnedProfileWithoutNetworkReload() async {
        ...
        presenter.profileUpdated(makeUserProfile(firstName: "Grace", lastName: "Hopper"))
    ...
    func editAndLogoutIntentsDelegateToRouterAndSessionOwner() async {
        ...
        presenter.profileUpdated(makeUserProfile(firstName: "Ada", lastName: "Lovelace"))
        presenter.editTapped()
